<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Products.aspx.cs" Inherits="MyDemo.Products" %>
...
<script type="text/javascript">qm_create(0,false,0,500,false,false,false,false,false);</script><!--[END-QM0]-->
	    ...
	    <div id="content">
	        ...
	        <table border="0" cellspacing="0" cellpadding="0" class="fluid">
                <tr>
	                <th align="left">&nbsp;</th>
	                <th align="left"><h4>Item #</h4></th>
	                <th align="left"><h4>Name</h4></th>
	                <th align="left"><h4>Description</h4></th>
	                <th align="left"><h4>Production Times</h4></th>
	                <th align="left"><h4>Packaging</h4></th>
	                <th align="left">&nbsp;</th>
	                <th align="left"><h4>Product ID</h4></th>
	                <th align="left"><h4>&nbsp;</h4></th>
                </tr>
                <tr>
                    <td>&nbsp;</td>
                    <td><asp:TextBox ID="tbxItemNum" runat="server"></asp:TextBox></td>
                    <td><asp:TextBox ID="tbxName" runat="server"></asp:TextBox></td>
                    <td><asp:TextBox id="tbxDescription" TextMode="multiline" Columns="50" Rows="3" runat="server" /></td>
                ...
                <asp:PlaceHolder id="ProductsDataPlaceHolder" runat="server"></asp:PlaceHolder>  
	            <tr>
	                <td>&nbsp;</td>
	                <td>&nbsp;</td>
	                <td>&nbsp;</td>
