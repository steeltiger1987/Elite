...
Dim rstTestNavigation_numRows

Set rstTestNavigation_cmd = Server.CreateObject ("ADODB.Command")
rstTestNavigation_cmd.ActiveConnection = MM_SID_STRING
rstTestNavigation_cmd.CommandText = "SELECT PageGroups.GroupName, PageGroups.TabOrder, Pages.PageTitle, Pages.PageAddress, PageGroups.PageGroupID, Pages.PageID FROM         PageGroups INNER JOIN                       Pages ON PageGroups.PageGroupID = Pages.PageGroupID WHERE     (Pages.NavigationPage = 1) AND (Pages.SatellitePage = 1) ORDER BY PageGroups.TabOrder, Pages.PageTitle" 
rstTestNavigation_cmd.Prepared = true

Set rstTestNavigation = rstTestNavigation_cmd.Execute
rstTestNavigation_numRows = 0
%>
...
<!-- Core QuickMenu Code -->
<script type="text/javascript">/* <![CDATA[ */qmv_iisv=1;
qmv7=true;var qm_si,qm_lo,qm_tt,qm_ts,qm_la,qm_ic,qm_ff,qm_sks;
