<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="QuoteInformation.aspx.cs" Inherits="MyDemo.QuoteInformation" %>
...
<script type="text/javascript">qm_create(0,false,0,500,false,false,false,false,false);</script><!--[END-QM0]-->
      ...
      <table border="0" cellspacing="0" cellpadding="0" class="box width-auto">
        <tr>
          <td>&nbsp;</td>
          <td colspan="2">
                <table border="0" cellspacing="0" cellpadding="0" class="width-auto quote-master">
                  <tr>
                    <td colspan="6"><h1>THE SOURCING SOLUTION</h1></td>
                  </tr>
                  <tr>
                    <td colspan="6"><h2>2701 FONDREN DR, SUITE 117, DALLAS, TX 75206</h2></td>
                  </tr>
                  <tr>
                    <td colspan="6"><h3>PH 888.602.2211   FX 888.602.5945   www.thesourcingsolution.com</h3></td>
                  </tr>
                  <tr>
                    <td><strong>TO:</strong></td>
                    <td colspan="5"><asp:Literal ID="lblClientName" runat="server"></asp:Literal></td>
                  </tr>
                  <tr>
                    <td><strong>COMPANY:</strong></td>
                    <td><asp:Literal ID="lblCompany" runat="server"></asp:Literal></td>
                    <td><strong>PROJECT:</strong></td>
                    <td><asp:Literal ID="lblProject" runat="server"></asp:Literal></td>
                    <td><strong>DATE:</strong></td>
                    <td><asp:Literal ID="lblQuoteDate" runat="server"></asp:Literal></td>
                  </tr>
                  <tr>
                    <td><strong>PHONE:</strong></td>
                    <td colspan="3"><asp:Literal ID="lblPhone" runat="server"></asp:Literal></td>
                    <td><strong>VALID:</strong></td>
                    <td><asp:Literal ID="lblValidDate" runat="server"></asp:Literal></td>
                  </tr>
                  <tr>
                    <td><strong>EMAIL:</strong></td>
                    <td colspan="3"><asp:Literal ID="lblEmail" runat="server"></asp:Literal></td>
                    <td><strong>QUOTE #:</strong></td>
                    <td><asp:Literal ID="lblQuoteNumber" runat="server"></asp:Literal></td>
                  </tr>
                </table>
          </td>
          <td>&nbsp;</td>
        ...
        <tr>
          <td>&nbsp;</td>
          <td colspan="2">
                <table border="1" cellspacing="1" cellpadding="0" class="box box4 width-auto">
                  <colgroup>
                    <col width="100px"/>
                    <col width="200px"/>
                    <col width=""/>
                  ...
                  <tr>
                    <td rowspan="2"><h4>IMAGE</h4></td>
                    <td rowspan="2"><h4>DESCRIPTION</h4></td>
                    <td rowspan="2"><h4>QTY</h4></td>
                    <td rowspan="2"><h4>PKG</h4></td>
                    <td rowspan="2"><h4>Pcs / Ctn</h4></td>
                    <td rowspan="2"><h4>Wgt in kg</h4></td>
                    <td colspan="3"><h4>Carton Size (cm)</h4></td>
                    <td rowspan="2"><h4># of Ctns</h4></td>
                    <td rowspan="2"><h4>CBM</h4></td>
                    <td rowspan="2"><h4>Lead Time</h4></td>
                    <td rowspan="2"><h4>FOB China Price</h4></td>
                    <td rowspan="2"><h4>Duties</h4></td>
                    <td rowspan="2"><h4>Ocean Freight FOB Dallas, TX</h4></td>
                    <td rowspan="2"><h4>Broker / Port / Fees</h4></td>
                    <td rowspan="2"><h4>Total Delivered Price</h4></td>
                  </tr>
                  <tr>
                    <td><h4>L</h4></td>
                    <td><h4>W</h4></td>
                  ...
                  <asp:PlaceHolder id="QuoteDataPlaceHolder" runat="server"></asp:PlaceHolder>
                </table>
          </td>
          <td>&nbsp;</td>
        </tr>
        <tr>
          <td>&nbsp;</td>
          <td colspan="2">
                      <p>The setup and inspection cost (unless otherwise noted) are in the fob cost.  Any special testing cost is not included.</p>
                      <p>Freight and Duties / Taxes / Brokerage are listed separately.</p>
                      <p>Sample and Pre-Production cost will be quoted separately by request.</p>
                      <p>Ocean freight adds 30 to 35 days to the lead time.  Local freight from Dallas will add 3 to 5 days.</p>
                      <p>The Sourcing Solution will not be held responsible for delays caused by weather, port congestion, customs inspections, or any other delays outside of our control.</p>
          </td>
          <td>&nbsp;</td>
        </tr>
      </table>
