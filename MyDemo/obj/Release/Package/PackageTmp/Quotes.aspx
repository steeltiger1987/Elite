<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Quotes.aspx.cs" Inherits="MyDemo.Quotes" %>
...
<script type="text/javascript">qm_create(0,false,0,500,false,false,false,false,false);</script><!--[END-QM0]-->
	...
	<table border="0" cellspacing="0" cellpadding="0" class="fluid">
	  <tr>
	    <th align="left"><h4>&nbsp;</th>
	    <th align="left"><h4>Quote Number</h4></th>
	    <th align="left"><h4>Project</h4></th>
	    <th align="left"><h4>To</h4></th>
	    <th align="left"><h4>Company</h4></th>
	    <th align="left"><h4>Phone</h4></th>
	    <th align="left"><h4>Email</h4></th>
	    <th align="left"><h4>Date</h4></th>
	    <th align="left"><h4>Valid</h4></th>
	    <th align="left"><h4>&nbsp;</h4></th>
      </tr>
	  <tr>
	    <td colspan="10"></td>
      </tr>
        <asp:PlaceHolder id="QuotesDataPlaceHolder" runat="server"></asp:PlaceHolder>  
	  <tr>
	    <td>&nbsp;</td>
	    <td>&nbsp;</td>
	    <td>&nbsp;</td>
