<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProductEdit.aspx.cs" Inherits="MyDemo.ProductEdit" %>
...
<script type="text/javascript">qm_create(0,false,0,500,false,false,false,false,false);</script><!--[END-QM0]-->
        ...
        <tr>
          ...
          <td>
              <asp:TextBox ID="tbxItemNum" runat="server" Columns="15"></asp:TextBox>
          </td>
          <td>&nbsp;</td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td>
              <asp:TextBox ID="tbxDescription" runat="server" TextMode="MultiLine" Columns="45" Rows="3"></asp:TextBox>
          </td>
          <td>&nbsp;</td>
        </tr>
        <tr>
          ...
          <td><asp:TextBox ID="tbxProdTimeLo" runat="server" Columns="5"></asp:TextBox> - <asp:TextBox ID="tbxProdTimeHi" runat="server" Columns="5"></asp:TextBox></td>
          <td>&nbsp;</td>
        </tr>
        <tr>
          <td>&nbsp;</td>
      ...
      <tr>
        ...
        <tr>
            ...
            <td>&nbsp;</td>
                ...
                <input type="hidden" name="htbxUploadFileName" id="htbxUploadFileName" value="" />
            </form>
            <!-- #EndEditable -->
