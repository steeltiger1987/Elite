<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProductInformation.aspx.cs" Inherits="MyDemo.ProductsInformation" %>
	    ...
	    <div id="content">
            ...
            <form id="frmAdd" runat="server">
                <table border="0" cellspacing="0" cellpadding="0" class="info">
                  ...
                  <tr>
                    <td>&nbsp;</td>
                    <td colspan="7"><asp:Label ID="ErrorMsg" runat="server" ></asp:Label></td>
                  </tr>
                  <tr>
                    <td>&nbsp;</td>
                    <td align="right"><strong>Item #</strong></td>
                    <td><asp:Literal ID="lblItemNum" runat="server"></asp:Literal></td>
                  ...
                  <tr>
                    ...
                    <td colspan="6"><asp:Literal ID="lblDescription" runat="server"></asp:Literal></td>
                  </tr>
                  <tr>
                    <td>&nbsp;</td>
                    <td align="right"><strong>Keywords</strong></td>
                    <td><asp:Literal ID="lblKeywords" runat="server"></asp:Literal></td>
                    <td align="right">&nbsp;</td>
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>
                  ...
                  <tr>
                    <td>&nbsp;</td>
                    <td align="right"><strong>Themes</strong></td>
                    <td><asp:Literal ID="lblThemes" runat="server"></asp:Literal></td>
                    <td align="right"><strong>Quote Upon Request</strong></td>
                    <td><asp:Literal ID="lblQuoteUponRequest" runat="server"></asp:Literal></td>
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>
                  </tr>
                  <tr>
                    <td>&nbsp;</td>
                    <td align="right"><strong>Decoration Method</strong></td>
                    <td><asp:Literal ID="lblDecorationMethod" runat="server"></asp:Literal></td>
                    <td align="right"><strong>Packaging</strong></td>
                    <td><asp:Literal ID="lblPackaging" runat="server"></asp:Literal></td>
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>
                  </tr>
                  <tr>
                    <td>&nbsp;</td>
                    <td align="right"><strong>Prod Times</strong></td>
                    <td><asp:Literal ID="lblProdTimeLo" runat="server"></asp:Literal> - <asp:Literal ID="lblProdTimeHi" runat="server"></asp:Literal></td>
                    <td align="right">&nbsp;</td>
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>
                  ...
                  <tr>
                    <td>&nbsp;</td>
                    <td align="right"><strong>Weight/Carton</strong></td>
                    <td><asp:Literal ID="lblWeightPerCarton" runat="server"></asp:Literal></td>
                    <td align="right"><strong>Units/Carton</strong></td>
                    <td><asp:Literal ID="lblUnitsPerCarton" runat="server"></asp:Literal></td>
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>
                  </tr>
                  <tr>
                    ...
                    <td><asp:Literal ID="lblCartonL" runat="server"></asp:Literal></td>
                    <td align="right"><strong>Comment</strong></td>
                    <td><asp:Literal ID="lblComment" runat="server"></asp:Literal></td>
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>
                  </tr>
                  <tr>
                    ...
                    <td colspan="6">
                      <div style="width:200px; height:auto; display:table-cell;">
                          <asp:Literal ID="lblProductImage" runat="server"></asp:Literal>
                      </div>
                    </td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    ...
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>
                    <td><asp:Button id="btnQuote" runat="server" Text="Quote" OnClick="btnQuote_Click" /></td>
                    <td>&nbsp;</td>
                  </tr>
                  <tr>
                    <td>&nbsp;</td>
                ...
                <table border="0" cellspacing="0" cellpadding="0" class="box">
                  ...
                  <tr>
                    <td>&nbsp;</td>
                    <td><asp:TextBox ID="tbxRMBPrice" runat="server" Columns="6"></asp:TextBox></td>
                    <td><asp:TextBox ID="tbxQuantity" runat="server" Columns="6"></asp:TextBox></td>
                    <td><asp:TextBox ID="tbxLeadTime" runat="server"></asp:TextBox></td>
                    <td><asp:Button id="btnAddCost" runat="server" Text="Add" OnClick="btnAddCost_Click" /></td>
                    <td>&nbsp;</td>
                  </tr>
                  <tr>
                    <td colspan="6"><hr /></td>
                  </tr>
                  <asp:PlaceHolder id="ProductCostsDataPlaceHolder" runat="server"></asp:PlaceHolder>  
                  <tr>
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>
                ...
                </table><table border="0" cellspacing="0" cellpadding="0" class="box">
                  <tr>
                    <th colspan="4"><h2>Themes</h2></th>
                  </tr>
                  <tr>
                    <td>&nbsp;</td>
                    <td>
                      <asp:DropDownList ID="cbxThemeID" runat="server"></asp:DropDownList>
                    </td>
                    <td><asp:Button id="btnAddTheme" runat="server" Text="Add" OnClick="btnAddTheme_Click" /></td>
                    <td>&nbsp;</td>
                  </tr>
                  <tr>
                    <td colspan="4"><hr /></td>
                  </tr>
                  <asp:PlaceHolder id="ProductThemesDataPlaceHolder" runat="server"></asp:PlaceHolder>
                </table>
                <table border="0" cellspacing="0" cellpadding="0" class="box">
                  <tr>
                  ...
                  <tr>
                    <td>&nbsp;</td>
                    <td>
                        <asp:DropDownList ID="cbxCategoryID" runat="server"></asp:DropDownList>
                    </td>
                  ...
                  <tr>
                    <td colspan="4"><hr /></td>
                      ...
                      <asp:PlaceHolder id="ProductCategorysDataPlaceHolder" runat="server"></asp:PlaceHolder>
                  <!--
                  <tr>
                    <td>&nbsp;</td>
                    <td colspan="8">Certain &quot;Products&quot; permissions are required to view this information.</td>
                  </tr>
                  -->
                </table>
<!-- #EndEditable -->
                <asp:HiddenField id="htbxProductID" runat="server" />
                <input type="hidden" name="MM_delete" id="MM_delete" value="" />
                <input type="hidden" name="MM_recordId" id="MM_recordId" value="" />
            </form>
            <!-- #EndEditable -->
...
<!--#includedd file="Includes/incFooter.aspx" -->
    ...
    <script type="text/javascript">
        ...
        function deleteCategory(id) {
            $('#MM_delete').val('category');
            $('#MM_recordId').val(id);
            $('#frmAdd').submit();
        };

        function submitQuote() {
            $('#frmAdd').attr('action', 'QuoteInput.aspx');
            $('#frmAdd').submit();
        };
    </script>
</body>
